...
Calcolare $ADD \: c_2c_3 = ((\lambda n. \lambda m. \lambda f. \lambda y. nf(mfx))\lambda f.\lambda x.f(fx))\lambda f.\lambda x.f(f(fx)) \rightarrow_\beta (\lambda m. \lambda f. \lambda y. (\lambda f.\lambda x.f(fx))f(mfx))\lambda f.\lambda x.f(f(fx))$
